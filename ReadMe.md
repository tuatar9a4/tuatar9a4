...
<ul align="center" > 
    <li list-style="none"><b><span style="font-size:100%">**MyFoodStyle**</span></b><br/>- 주변 음식점의 카테고리와 리뷰를 작성할 수 있는 앱 <br/>- Naver 지도 api 와 firebase 실시간 데이터 데이스를 사용하여 DB를 구축</li>
<br/>
